...
**Starvation** caused by Rule 4b.

```bash
$ py ./mlfq.py -l 0,200,0:100,50,5:100,50,5 -i 5 -S -c
...
# ==============================================================================
# NOTE: End of figure 8.5 Left
# NOTE: The remaining part is irrelevant since the purpose of this
# simulation is to demonstrate the phenomenon of starvation caused by
# a bad scheduling algorithm as applied in figure 8.4, i.e., in total
# disregard of the queue level allotment time process are never demoted
# while the CPU-burst is less than the queue time slice (quantum).
# Consequently till Time 200, processes 1 and 2 have effectively starved
# process 0 from any CPU time.
# ==============================================================================
